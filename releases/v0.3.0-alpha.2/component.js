...
define("nodes/components/driver-linode/component", ["exports", "shared/mixins/node-driver"], function (exports, _nodeDriver) {
  ...
  (0, _nodeDriver.registerDisplayLocation)(new _nodeDriver.DynamicDependentKeysProperty({
    driver: 'linode',
    keyOrKeysToWatch: 'config.region'
  }));
  (0, _nodeDriver.registerDisplaySize)(new _nodeDriver.DynamicDependentKeysProperty({
    driver: 'linode',
