define('nodes/components/driver-linode/component', ['exports', 'shared/mixins/node-driver'], function (exports, _nodeDriver) {
  ...
  (0, _nodeDriver.registerDisplayLocation)(new _nodeDriver.DynamicDependentKeysProperty({ driver: 'linode', keyOrKeysToWatch: 'config.region' }));
  (0, _nodeDriver.registerDisplaySize)(new _nodeDriver.DynamicDependentKeysProperty({ driver: 'linode', keyOrKeysToWatch: 'config.instanceType' }));
  ...
  exports.default = Ember.Component.extend(_nodeDriver.default, {
    ...
    apiRequest: function apiRequest(path, auth) {
      return fetch('https://api.linode.com' + path).then(function (res) {
